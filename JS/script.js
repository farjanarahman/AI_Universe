                ...
                <div class="subscibe d-flex fw-semibold mt-3">
                  ...
                  <div class="features-int d-flex mt-3">
                    <div class="feature">
                      ...
                      <ul class="text">${app.data.features ? Object.values(app.data.features).map(item=>`<li>${item.feature_name}</li>`).join(''): 'No data'}</ul>
                    </div>
                   <div class="int">
                    <h3 class="int-head">Integrations</h3>
                    <ul class="text">${app.data.integrations ? Object.values(app.data.integrations).map(items=>`<li>${items}</li>`).join(''): 'No data'}</ul>
                  </div>
                  </div>
                </div>
